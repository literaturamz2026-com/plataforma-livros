        ...
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          <div className="flex-1 max-w-sm hidden md:block">
            <div className="relative">
              ...
              <input
                ...
                className={inp + ' w-full pl-9 pr-4 py-2 rounded-lg text-sm border outline-none focus:border-orange-400'}
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              ...
              className={(dark ? 'bg-gray-800 text-yellow-400' : 'bg-gray-100 text-gray-600') + ' p-2 rounded-lg text-base'}
            >
              {dark ? '☀️' : '🌙'}
            </button>
            ...
            {user ? (
              <div className="hidden md:flex items-center gap-2">
                ...
                <button
                  onClick={onLogout}
                  className="border border-gray-600 text-gray-300 px-4 py-2 text-sm rounded-lg hover:bg-gray-800"
                >
                  Sair
                </button>
              </div>
              ...
              <div className="hidden md:flex items-center gap-2">
                <button
                  ...
                  className={(dark ? 'text-gray-300' : 'text-gray-600') + ' px-4 py-2 text-sm rounded-lg'}
                >
                  Entrar
                </button>
                <button
            ...
            <button
              ...
              className={(dark ? 'text-gray-300' : 'text-gray-600') + ' lg:hidden p-2 rounded-lg text-xl'}
            >
              {menuOpen ? 'x' : '☰'}
            </button>
          </div>
