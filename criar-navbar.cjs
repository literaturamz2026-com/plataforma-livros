  ...
  return (
    <div>
      ...
      <footer className={dark ? "border-t border-gray-800 bg-gray-900" : "border-t border-gray-200 bg-white"}>
        ...
        href="https://wa.me/258827429678"
        target="_blank"
        rel="noreferrer"
        title="Fale connosco no WhatsApp"
        style={{position:"fixed", bottom:"24px", right:"24px", zIndex:999, width:"56px", height:"56px", borderRadius:"50%", display:"flex", alignItems:"center", justifyContent:"center", fontSize:"1.5rem", boxShadow:"0 4px 12px rgba(0,0,0,0.3)", backgroundColor:"#22c55e", color:"white", textDecoration:"none"}}
      >
        💬
      </a>
